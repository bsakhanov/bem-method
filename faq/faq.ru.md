...
* [Почему нежелательно совмещать теги и классы в селекторе?](#Почему-нежелательно-совмещать-теги-и-классы-в-селекторе)
* [Почему нежелательно использовать вложенные селекторы?](#Почему-нежелательно-использовать-вложенные-селекторы)
* [Почему нежелательно использовать комбинированные селекторы?](#Почему-нежелательно-использовать-комбинированные-селекторы)
* [Почему нежелательно использовать селекторы по пользовательским тегам?](#Почему-нежелательно-использовать-селекторы-по-пользовательским-тегам)
...
2. Нужна только для данного окружения и в данном виде точно не будет переиспользована на проекте, необходимо создавать микс. Например, в большинстве случаев создается микс, если:
...
После чего совместить реализацию разных блоков с помощью [миксов](../method/key-concepts/key-concepts.ru.md#Микс).
...
## Почему нежелательно совмещать теги и классы в селекторе?
...
## Почему нежелательно использовать комбинированные селекторы?
...
## Почему нежелательно использовать селекторы по пользовательским тегам?
